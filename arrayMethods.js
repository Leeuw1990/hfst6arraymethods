...
const sixteen = inventors.filter((inventor) => {
...
const invent = inventors.map((inventor) => {
...
//[] -- function maken.
//[] -- sort in functie verwerken.
//[] -- Van hoog naar laag. Dus b,a
//[] -- Door de array heen for-loopen.
//[] -- Vergelijk year en passed met elkaar.
//[] -- Uitkomst passed - year = leeftijd.
//[] -- return leeftijd van hoog naar laag.
const highestAge = inventors.sort((b,a) => {
